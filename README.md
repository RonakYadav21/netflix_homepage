...
<head>
    ...
    <title>Netflix India - home page</title>
    <style>
        *{
    padding: 0;
    margin: 0;
...
.container::before{
    content: "";
    background: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSePcecalGyrZlu_V2RNWacdO_GVgpqaEudeQ&usqp=CAU) no-repeat center center/cover;
    position: absolute;
    height: 100%;
    width: 100%;
    opacity: 0.3;
